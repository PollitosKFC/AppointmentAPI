...
public interface AppointmentService {
    ...
    Appointment updateAppointment(Appointment appointment, Long customerId, Long technicianId);
    Appointment deleteAppointment(Appointment appointment, Long customerId, Long technicianId);
